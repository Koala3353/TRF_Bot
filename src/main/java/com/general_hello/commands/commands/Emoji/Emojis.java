    ...
    public static String stringToEmoji(String input)
    {
        ...
        for (int i = 0; i < input.length(); i++)
        {
            ...
            //Spacing
                ...
                switch(letters) {
                    case ".":
                        output.append(Emojis.DOT);
                        break;
                    case "?":
                        output.append(Emojis.MARK_QUESTION);
                        break;
                    case "!":
                        output.append(Emojis.MARK_EXCLAMATION);
                        break;
                    case "#":
                        output.append(Emojis.MARK_HASH);
                        break;
                    case "*":
                        output.append(Emojis.MARK_ASTERISK);
                        break;
                    case "&":
                    case "%":
                        output.append(Emojis.SYMBOLS);
                        break;
                    case "+":
                        output.append(Emojis.MARK_PLUS_SIGN);
                        break;
                    case "-":
                        output.append(Emojis.MARK_MINUS_SIGN);
                        break;
                    case "/":
                        output.append(Emojis.MARK_DEVIDE_SIGN);
                        break;
                    default:
                        break;
                }
