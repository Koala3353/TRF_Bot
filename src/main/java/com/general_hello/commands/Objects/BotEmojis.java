...
public class BotEmojis {
    //coins
    public final static String currency = "<:4Currency:949050677441749023>";
    ...
    public final static String check = "<:check:957420541256531969>";
    public final static String xmark = "<:xmark:957420842898292777>";
}
