...
public class RPGDataUtils {
    ...
    public static String getNameFromUser(User user) {
        try {
            return Data.userUserPhoneUserHashMap.get(user).getUserPhoneUserName();
    ...
    public static String getNameFromUser(long userId) {
        try {
            return Data.userUserPhoneUserHashMap.get(Bot.jda.getUserById(userId)).getUserPhoneUserName();
        } catch (Exception ignored) {}
        return "Unknown";
    }
}