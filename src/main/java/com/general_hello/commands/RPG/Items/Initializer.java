...
public class Initializer {
    ...
    public static HashMap<String, Chest> chestToId = new HashMap<>();
    ...
    public static void initializer() {
        ...
        new SeaAnimal(Rarity.RARE, "Shrimp", "<:shrimpy:932828459535831040>");
        //Legendary
        ...
        new SeaAnimal(Rarity.LEGENDARY, "Crab", "<a:crabby:900170344202113096>", "Powerful yet small, a crab is.", 40_000_000);
        new SeaAnimal(Rarity.LEGENDARY, "Lobster", "", "Brother of crab.", 50_000_000);
        new SeaAnimal(Rarity.LEGENDARY, "Jonah's Big Fish", "<:jonah_big_fish:899872152961044521>");
        //Mythical
        new SeaAnimal(Rarity.MYTHICAL, "Mythical Fish", "<:mythical_fish:923382428981162004>", "Impossible to have one if ye are poor", 100_000_000);
        new SeaAnimal(Rarity.MYTHICAL, "Kraken", "<:kraken:899871980017311795>", "No one knows what this creature is!", 150_000_000);
        ...
        //Legendary
        new LandAnimal(Rarity.LEGENDARY, "Dinosaur", "<:dinosaur:905241832550699099>", "The most delicious animal!", 60_000_000);
        //Mythical
        new LandAnimal(Rarity.MYTHICAL, "Rhino", "", "A mythical creature only seen and eaten by the richest of the richest", 110_000_000);
        ...
        //Artifacts
        new Artifact(Rarity.COMMON, "Clay Pot", "<:clay_pot:899872733758898227>", "A pot that is filled with clay", 700_000);
        new Artifact(Rarity.COMMON, "Sack Cloth", "<:sack:899873147048820748>", "A sack made of cloth", 1_000_000);
        new Artifact(Rarity.UNCOMMON, "Wine Skin", "<:wine_skin:912589755668111421>", "A wine skin. Whatever that is.", 5_000_000);
        new Artifact(Rarity.RARE, "Ruby", "<:ruby:899873184554315816>", "A beautiful ruby for a special person 😉", 15_000_000);
        new Artifact(Rarity.RARE, "Stones of David", "<:david_stones:899873415098417162>", "The five stones used by David to kill Goliath", 29_000_000);
        new Artifact(Rarity.RARE, "Coat of Joseph", "<:robe:914676817036705863>", "A colorful coat given to Joseph then given to you", 40_000_000);
        new Artifact(Rarity.LEGENDARY, "Diamond", "<:diamond:899873834549780512>", "Diamond... A gem.", 50_000_000);
